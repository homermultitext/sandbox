...
# ╔═╡ 4804f7e6-f319-11eb-2d03-addeeb702f03
begin
	using CitableText
	using CitableCorpus
	using CitableObject
...
# ╔═╡ 90329768-d72e-4bc2-b62d-28177f3b5541
md"> # Venetus A manuscript facsimile"

# ╔═╡ 365c9814-03ea-4c93-a659-09211cdc0d70
md"> Load data"

# ╔═╡ 9fb82f40-de78-4af4-a5d2-ed9a120d778c
function codex_va()
	vaurl = "https://raw.githubusercontent.com/homermultitext/hmt-archive/master/archive/codices/vapages.cex"
	blocks = CiteEXchange.fromurl(vaurl)
	data = datafortype("citedata", blocks)	
	CSV.File(IOBuffer(join(data,"\n")), delim="|") |> DataFrame
end

# ╔═╡ 96bea89b-bd38-445b-b10a-cd2177713207
codex = codex_va()

# ╔═╡ 67a92cfc-7fef-4fd3-8fd2-94700c1d2b40
urns = map(s -> Cite2Urn(s), codex[:,:urn])

# ╔═╡ fea6aad8-6925-45f7-b467-fb798436cba5
menu = map(u -> objectcomponent(u), urns)

# ╔═╡ fddeab44-6a3d-4aad-9a74-ff7cfb14e5a2
md"""Folio $(@bind pg Select(menu, default = "1r"))
"""

# ╔═╡ 1c749b73-1abd-4213-960c-a054576cdb73
md"Show facsimile for page $pg"

# ╔═╡ 6cdb9283-153b-4a2c-82f8-873970fdb9f8
function dse_va()
	vaurl = "https://raw.githubusercontent.com/homermultitext/hmt-archive/master/archive/dse-data/dserelations-va.cex"
	blocks = CiteEXchange.fromurl(vaurl)
	data = datafortype("citerelationset", blocks)
	CSV.File(IOBuffer(join(data,"\n")), delim="|", skipto=4) |> DataFrame
end

# ╔═╡ 9ba7af16-0586-4988-ae81-9627513d4b0c
dse_va()
...
git-tree-sha1 = "a9ace3785ab2e5bff2daf0b6ffecc95c6b20ba7e"
